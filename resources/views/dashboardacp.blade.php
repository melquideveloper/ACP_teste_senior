        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('login') }}" id="form-register">
                    ...
                    <div id="passo1">
                        <!-- Tipo de cadastro -->
                        <img class="loadmatriculas" id="livroloading" src="uploads/Livro.gif" width="70px" height="70px" style="margin: 1% auto; display:none">
                        <div class="flex items-center mt-4">
                            <label class="block font-medium text-sm text-gray-700" for="codescola">
                                Escolas:
                            </label>

                            <select name="codescola" id="codescola" class="ml-4" onchange="buscarTurmas(this.value)">
                                <option value="0">SELECTIONE A ESCOLA</option>
                            </select>
                        </div>
                        <div class="flex items-center mt-4">
                            <label class="block font-medium text-sm text-gray-700" for="calendario">
                                Calendário:
                            </label>
                            <legend>2024</legend>
                        </div>
                        <div class="flex items-center mt-4">
                            <label class="block font-medium text-sm text-gray-700" for="turmas">
                                Turmas:
                            </label>
                            <select name="turmas" id="turmas" class="ml-4">
                            </select>
                        </div>
